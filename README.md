...
---
##### Пример генерации текста в контектсе pdf сохраненного моего сайта\блога. Нейронки с чувством юмора!

```
Enter Question: 
- Расскажи о ком речь в документе , стоит его на работу брать ?
- Приветствую! 
...
Из этой записи следует, что этот человек по-прежнему является поиской работы, и ему необходим collective support (т.е. коллективное давление).
Enter Question: ...
