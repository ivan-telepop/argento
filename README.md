...
> [!NOTE]
> Приложение в процессе дополнения и разработки.
...
- Через админ панель загружается документация (текст файлы или PDF).
- Документация переобразуется в векрторы   и хранится в Vector Storage (SDK например Pinecone).
...
- Ендпоинт возвращает сгенерированные ответы моделью в контексте задачи.
